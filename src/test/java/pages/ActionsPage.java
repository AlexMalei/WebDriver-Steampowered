...
import projectUtils.GameDiscountFilter;
...
public class ActionsPage extends BasePage {
    ...
    public void chooseSpecialsCategory(){
        WebElement specials = driver.findElement(specialsElementLocator);
        specials.click();
    }
    ...
    public void getMaxDiscountGame(){
        ...
        GameDiscountFilter gdf = new GameDiscountFilter(discountElements);
        gdf.getGameMaxDiscount().click();
    }
